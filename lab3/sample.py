...
class EncoderRNN(nn.Module):
    def __init__(self, input_size, hidden_size, condition_size):
        ...
        self.lstm = nn.LSTM(hidden_size + condition_size, hidden_size)
...
class DecoderRNN(nn.Module):
    ...
    def forward(self, input, hidden, c=None):
...
def trainIters(encoder, decoder, n_iters, print_every=1000, plot_every=100, learning_rate=0.01):
    ...
    plt.xticks(np.linspace(0, n_iters, n_iters / plot_every))
...
train_data, test_data = MyDataset(dataFromFile("data/train.txt")), MyDataset(dataFromFile("data/test.txt"))
